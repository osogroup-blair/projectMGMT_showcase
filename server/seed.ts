...
export async function seedDatabase() {
  try {
    ...
    const tasks = [
      ...
      { id: "t3", title: "Bug Fixing", description: "Fix the reported crash on the user profile page when uploading large avatars.", project: "Kraft HR", projectId: "3", stageId: "st_enable", epicId: "e2", status: "Todo", deadline: "2025-01-18", priority: "High", assigneeId: "5", milestoneId: "m4", estimateHours: 2, tags: ["Bug", "Urgent"] },
      { id: "t4", title: "System Optimization", description: "Optimize database queries for faster load times on the reports page.", project: "Colgate-Palmolive Retool", projectId: "2", stageId: "st_develop", epicId: "e2", status: "Todo", deadline: "2025-01-22", priority: "Medium", assigneeId: "2", milestoneId: "m3", estimateHours: 8, tags: ["Database", "Performance"] },
      { id: "t5", title: "API Development", description: "Create REST endpoints for the mobile app to fetch user settings.", project: "Houlihan Lokey Rebrand", projectId: "1", stageId: "st_develop", epicId: "e2", status: "Todo", deadline: "2025-01-25", priority: "High", assigneeId: "5", milestoneId: "m3", estimateHours: 16, tags: ["API", "Backend"] },
      { id: "t6", title: "Testing and QA", description: "Run regression tests before the release. Document any failures in JIRA.", project: "Kraft HR", projectId: "3", stageId: "st_enable", epicId: "e2", status: "Todo", deadline: "2025-01-28", priority: "Low", assigneeId: "7", milestoneId: "m4", estimateHours: 6, tags: ["QA", "Testing"] },
      ...
      { id: "t8", title: "Client Meeting Prep", description: "Prepare slides for the weekly status update. Include metrics on velocity and burn-down.", project: "Houlihan Lokey Rebrand", projectId: "1", stageId: "st_plan", epicId: "e3", status: "Done", deadline: "2025-01-05", priority: "High", assigneeId: "1", milestoneId: "m1", estimateHours: 2, tags: ["Management", "Client"] },
      { id: "t9", title: "User Research", description: "Conduct user interviews and compile findings for the brand refresh.", project: "Houlihan Lokey Rebrand", projectId: "1", stageId: "st_plan", epicId: "e3", status: "Done", deadline: "2025-01-08", priority: "Medium", assigneeId: "3", milestoneId: "m1", estimateHours: 8, tags: ["Research", "UX"] },
      { id: "t10", title: "Wireframe Review", description: "Review and approve wireframes for the new website sections.", project: "Houlihan Lokey Rebrand", projectId: "1", stageId: "st_validate", epicId: "e1", status: "In Progress", deadline: "2025-01-18", priority: "High", assigneeId: "3", milestoneId: "m2", estimateHours: 6, tags: ["Design", "Review"] },
      { id: "t11", title: "Content Migration", description: "Migrate existing content to the new CMS structure.", project: "Houlihan Lokey Rebrand", projectId: "1", stageId: "st_develop", epicId: "e2", status: "Todo", deadline: "2025-02-01", priority: "Medium", assigneeId: "5", milestoneId: "m3", estimateHours: 20, tags: ["CMS", "Migration"] },
      { id: "t12", title: "Training Materials", description: "Create training documentation for the new brand guidelines.", project: "Houlihan Lokey Rebrand", projectId: "1", stageId: "st_enable", epicId: "e1", status: "Todo", deadline: "2025-02-15", priority: "Low", assigneeId: "2", milestoneId: "m4", estimateHours: 10, tags: ["Documentation", "Training"] },
    ];
