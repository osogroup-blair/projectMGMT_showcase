...
const COLUMNS = [
  { id: "todo", title: "To Do", statuses: ["To Do", "Pending"], icon: Circle, color: "text-slate-500", bgColor: "bg-slate-50", borderColor: "border-slate-200" },
  { id: "inprogress", title: "In Progress", statuses: ["In Progress"], icon: Clock, color: "text-blue-500", bgColor: "bg-blue-50", borderColor: "border-blue-200" },
