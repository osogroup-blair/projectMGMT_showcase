...
export const SCHEMA_DEFINITIONS: Record<string, SchemaDefinition[]> = {
  all: [
    ...
    { sheet: "Milestones", columns: ["id", "projectId", "name", "description", "stageId", "targetDate", "status", "ownerId", "scopeType", "completionMode", "completionTargetPercent", "tags", "createdAt", "updatedAt", "progressTotalTasks", "progressCompletedTasks", "progressPercentComplete", "progressLastCalculatedAt", "progressPercent", "isBillingGate", "requiredCompletionRatio", "scopeRules", "createdBy", "updatedBy"] },
    ...
    { sheet: "MilestoneTemplates", columns: ["id", "name", "description", "scopeType", "completionMode", "completionTargetPercent", "isBillingGate", "offsetDays", "stageTemplateId", "order", "defaultScopeRules"] },
