      ...
      <div className="flex">
        <aside className="w-64 shrink-0 sticky top-0 h-screen overflow-y-auto border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="p-4 border-b">
            ...
            <p className="text-xs text-muted-foreground truncate" title={state.sourceFileName || undefined}>
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors text-left ${isActive
