...
type SampleSection = "core" | "tasks" | "milestones" | "sprints" | "comments" | "all";
    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          Generate a realistic "Website Redesign" project to demo all features
        </CardDescription>
      </CardHeader>
          ...
          <>
            <div className="flex gap-2">
              <Button
                ...
                data-testid="button-generate-all-sample"
              >
                {isGenerating ? (
                  <>
            ...
            <div className="space-y-2">
              <p className="text-xs text-muted-foreground font-medium">Generate by Section:</p>
